...
version = get_version("django_mptt_comments", "__init__.py")
...
setup(
    ...
    author='Xueguang Yang',
    author_email='zmrenwu@163.com',
    url='https://github.com/zmrenwu/django-mptt-comments',
    packages=[
